...
import org.sensapp.android.sensappdroid.clientsamples.sensorlogger.sensorimpl.RemoteSensor;
 ...
 */
public class RemoteSensorLoggerTask extends AbstractSensorLoggerTask{

    public RemoteSensorLoggerTask(RemoteSensor rs, Context c){
        super(rs, c);
    }
